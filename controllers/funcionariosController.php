...
class funcionariosController extends Controller
{
    ...
    public function index()
    {
        ...
        $this->_view->assign('funcionarios', Funcionario::with('comuna','roles')->orderBy('id','DESC')->get());
    ...
    public function edit($id = null)
    {
        ...
        if ($this->getAlphaNum('enviar') == CTRL) {
            ...
            if (!$this->getSql('date_in')) {
                $this->_view->assign('_error', 'Ingrese la fecha de contrato');
            ...
            $funcionario->date_in = $this->getSql('date_in');
